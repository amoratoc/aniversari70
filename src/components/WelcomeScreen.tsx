...
export default function WelcomeScreen({ onStart, calendarData }: WelcomeScreenProps) {
  return (
    <div className="min-h-screen bg-linear-to-br from-pastel-peach via-pastel-sky to-pastel-mint flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-visible border-4 border-white">
          ...
          <div className="p-4 sm:p-8 text-center">
            ...
            <div className="mb-6 space-y-2">
              <h1 className="text-5xl sm:text-6xl font-bold bg-linear-to-r from-pastel-lavender via-pastel-pink to-pastel-blush bg-clip-text text-transparent drop-shadow-sm">
                70 dies
              </h1>
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-10 left-10 text-3xl opacity-20 animate-bounce">💕</div>
          <div className="absolute top-40 right-10 text-2xl opacity-20 animate-bounce delay-200">🌸</div>
          <div className="absolute bottom-32 left-20 text-3xl opacity-20 animate-bounce delay-300">⭐</div>
          <div className="absolute bottom-55 right-12 text-2xl opacity-20 animate-bounce delay-100">🎈</div>
        </div>
      </div>
    </div>
  );
